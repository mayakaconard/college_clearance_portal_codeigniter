    ...
    <section class="content">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <span class="glyphicon glyphicon-education"></span>&nbsp;&nbsp;Students with Arares per School per Department</div>
    ...
    ?>
                      ...
                      <i class="glyphicon glyphicon-trash"></i>
                                        ...
                                        <div>
                                            <div id="update<?php echo $sa['arares_id']; ?>" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    <!-- Modal content-->
                                                    <form action="<?php echo base_url('Admin/updateArares/' . $sa['arares_id']); ?>" method="post">
                                ...
                                <?php echo $sa['surname']; ?>
                                                        ...
                                                        <div class="modal-footer">
                                                            <button class="btn btn-info" data-dismiss="modal" aria-hidden="true">No</button>
                                                            <a href="<?php echo base_url('Admin/DeleteStudentArares/' . $sa['arares_id']); ?>" class="btn btn-danger">Yes</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <?php
